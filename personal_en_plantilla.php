    ...
    <section class="seccion-btn-group">
        <form>
                ...
                <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                    ...
                    <label class="btn btn-outline-primary" for="btnradio1" onclick="showSection('Personal')">Personal de la Subsecretaría de Control de Tránsito</label>
        ...
        <section id="Personal" class="info-section-personal">
                <?php include 'Personal/PersonalSCT.php';?>
        </section>
        
     <script>
        function showSection(sectionId) {
        var sections = document.querySelectorAll('.info-section-personal');
